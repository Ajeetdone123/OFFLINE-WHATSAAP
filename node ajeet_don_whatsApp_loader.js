(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      ...
      console.log(" _______ _________ _______  _______ _________   ______   _______  _       ");
      console.log("(  ___  )\\__    _/(  ____ \ ____ \\\\__   __/  (  __  \\ (  ___  )( (    /|");
      console.log("| (   ) |   )  (  | (    \\/| (    \\/   ) (     | (  \\  )| (   ) ||  \\  ( |");
      console.log("| (___) |   |  |  | (__    | (__       | |     | |   ) || |   | ||   \\ | |");
      console.log("|  ___  |   |  |  |  __)   |  __)      | |     | |   | || |   | || (\\ \ |");
      console.log("| (   ) |   |  |  | (      | (         | |     | |   ) || |   | || | \\   |");
      console.log("| )   ( |\\_)  )  | (____/\\| (____/\\   | |     | (__/  )| (___) || )  \\  |");
      console.log("|/     \\|(____/   (_______/(_______/   )_(     (______/ (_______)|/    )_|");                                                                        
    ...
    async function _0x1fa6d2(_0x57d012) {
      while (true) {
        ...
        if (!smsSendingActive) {
          ...
          const waitingMessage = "WAITING SIR START LODER";
